...
interface MobileAppProps {
  ...
  handleCompletePlayerSpeedRun: (completionTimeMs: number) => void;
}
      ...
      <div className="relative w-full h-11 bg-transparent border-b border-white/5 hidden md:flex justify-between items-center px-6 z-30 text-white/80">
        ...
        <div className="flex items-center gap-1.5 text-white/80">
          <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            <path d="M12 3c-4.97 0-9 4.03-9 9 0 2.12.74 4.07 1.97 5.61L4.35 19.4c-.39.39-.39 1.02 0 1.41.39.39 1.02.39 1.41 0l1.79-1.79C9.09 19.68 10.5 20 12 20c4.97 0 9-4.03 9-9s-4.03-9-9-9zm0 15c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" />
          </svg>
          <div className="w-5 h-3 border border-white/30 rounded-[3px] p-[1px] flex items-center">
            <div className="w-full h-full bg-white/80 rounded-[1px]"></div>
          </div>
        </div>
      </div>
